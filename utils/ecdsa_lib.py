...
def privkey_to_pubkey(pv_key_int, curve_name="SECP256K1"):
...
def compute_public_key(private_key: int) -> list[int]:
    """Compute public key point coordinates from a private key integer.
    Returns [x, y] coordinates of the resulting public key point.
    """
